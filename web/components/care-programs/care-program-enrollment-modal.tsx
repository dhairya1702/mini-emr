      ...
      <form onSubmit={submit} className="relative mx-auto w-full max-w-2xl rounded-lg border border-[#dbe7ef] bg-white p-5 shadow-[0_24px_80px_rgba(15,23,42,0.25)]">
        ...
        {mode === "existing" ? (
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            ...
            <label className="text-sm font-medium text-slate-700">Sex<select value={newPatient.sex_at_birth || ""} onChange={(event) => updateNewPatient("sex_at_birth", (event.target.value || null) as SexAtBirth | null)} className="mt-1 w-full rounded-lg border border-[#bfd7e8] bg-white px-3 py-2.5"><option value="">Not recorded</option><option value="female">Female</option><option value="male">Male</option><option value="intersex">Intersex</option><option value="prefer_not_to_say">Prefer not to say</option><option value="unknown">Other</option></select></label>
