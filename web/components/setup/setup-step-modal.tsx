...
function buildSettingsPayload(
  ...
  return {
    ...
    document_template_signature_x: settings.document_template_signature_x,
    document_template_signature_y: settings.document_template_signature_y,
    document_template_signature_width: settings.document_template_signature_width,
    document_template_signature_height: settings.document_template_signature_height,
    document_template_doctor_name_x: settings.document_template_doctor_name_x,
    document_template_doctor_name_y: settings.document_template_doctor_name_y,
    document_template_doctor_name_width: settings.document_template_doctor_name_width,
    document_template_doctor_name_height: settings.document_template_doctor_name_height,
