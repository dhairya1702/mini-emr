        ...
        <div className="grid gap-3 md:grid-cols-[110px_repeat(9,minmax(0,1fr))]">
          ...
          {value.eyes.map((entry) => (
            <Fragment key={entry.eye}>
              ...
              <input value={entry.sphere} onChange={(event) => onEyeChange(entry.eye, { sphere: event.target.value })} className="rounded-2xl border border-sky-100 bg-sky-50/50 px-3 py-3 text-slate-800 outline-none transition focus:border-sky-400" placeholder="-1.25" />
              <input value={entry.cylinder} onChange={(event) => onEyeChange(entry.eye, { cylinder: event.target.value })} className="rounded-2xl border border-sky-100 bg-sky-50/50 px-3 py-3 text-slate-800 outline-none transition focus:border-sky-400" placeholder="-0.75" />
              <input value={entry.axis} onChange={(event) => onEyeChange(entry.eye, { axis: event.target.value })} className="rounded-2xl border border-sky-100 bg-sky-50/50 px-3 py-3 text-slate-800 outline-none transition focus:border-sky-400" placeholder="90" />
              <input value={entry.base_curve} onChange={(event) => onEyeChange(entry.eye, { base_curve: event.target.value })} className="rounded-2xl border border-sky-100 bg-sky-50/50 px-3 py-3 text-slate-800 outline-none transition focus:border-sky-400" placeholder="8.6" />
              <input value={entry.diameter} onChange={(event) => onEyeChange(entry.eye, { diameter: event.target.value })} className="rounded-2xl border border-sky-100 bg-sky-50/50 px-3 py-3 text-slate-800 outline-none transition focus:border-sky-400" placeholder="14.2" />
              <input value={entry.add_power} onChange={(event) => onEyeChange(entry.eye, { add_power: event.target.value })} className="rounded-2xl border border-sky-100 bg-sky-50/50 px-3 py-3 text-slate-800 outline-none transition focus:border-sky-400" placeholder="+1.50" />
              <input value={entry.visual_acuity} onChange={(event) => onEyeChange(entry.eye, { visual_acuity: event.target.value })} className="rounded-2xl border border-sky-100 bg-sky-50/50 px-3 py-3 text-slate-800 outline-none transition focus:border-sky-400" placeholder="6/6" />
              <input value={entry.over_refraction} onChange={(event) => onEyeChange(entry.eye, { over_refraction: event.target.value })} className="rounded-2xl border border-sky-100 bg-sky-50/50 px-3 py-3 text-slate-800 outline-none transition focus:border-sky-400" placeholder="-0.25 DS" />
              <input value={entry.fit_notes} onChange={(event) => onEyeChange(entry.eye, { fit_notes: event.target.value })} className="rounded-2xl border border-sky-100 bg-sky-50/50 px-3 py-3 text-slate-800 outline-none transition focus:border-sky-400" placeholder="Good centration" />
            </Fragment>
          ))}
        </div>
      </div>
