...
const EXAM_STRUCTURES = ["Appearance", "Adnexa", "Conjunctiva", "Sclera", "Cornea", "Anterior chamber (AC)", "Pupil", "Iris", "Lens", "Vitreous", "Choroid", "Fundus"];
